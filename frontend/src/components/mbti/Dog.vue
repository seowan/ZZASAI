  ...
  <div id="char-test6">
    ...
    <div class="py-3 my-1"></div>
      <div class="row">
        ...
        <div class="col-5">
        <h2><br>ENFJ는 자신의 의견을 내세우기 보다 <br>
        다른 사람들의 생각과 의견을 더 중요하게 생각하는 유형이다.</h2>
        <br>
        <h2> 
        눈치가 빠르고 여러 사람과 협업이 가능하다는 점에서
        <br>ENFJ는 동물 중 강아지와 많이 닮아있다고 할 수 있다.
        </h2>
        <br>
        <h2>
        상대방의 감정을 살피면서도 궁금한 건 못 참아서 <br>
